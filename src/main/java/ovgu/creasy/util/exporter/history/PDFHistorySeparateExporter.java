...
public class PDFHistorySeparateExporter extends AbstractHistoryExporter {
    private final boolean includeDiffAndText;

    public PDFHistorySeparateExporter(List<CreasePatternCanvas> history) {
        this(history, true);
    }

    public PDFHistorySeparateExporter(List<CreasePatternCanvas> history, boolean includeDiffAndText) {
        this.history = history;
        this.includeDiffAndText = includeDiffAndText;
    }
